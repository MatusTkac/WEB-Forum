...
import { PostThread } from './pages/post-thread/post-thread';
...
export const routes: Routes = [
  ...
  // Post Thread page - view original post and its replies
  {path: 'post/:id', component: PostThread, canActivate: [authGuard]},
